...
const WebARRocksLMStabilizer = (function () {
  ...
  function mix_vec2(u, v, t, r) {
    ;(r[0] = u[0] * (1 - t) + v[0] * t), (r[1] = u[1] * (1 - t) + v[1] * t)
  }
  ...
  const superThat = {
    instance: function (spec) {
      const _spec = Object.assign(
        {
          ...
          strengthStallThreshold: 50000, // disable stabilization is strength is > this value
      ...
      let _lmsStabilized = null,
        _lmsStabilizedPx = null
      ...
      function compute_stabilized() {
        ...
        if (
          !_isStalled &&
          _meanForce > _spec.strengthStallThreshold + _spec.strengthStallThresholdHysteresis
        ) {
          _isStalled = true
